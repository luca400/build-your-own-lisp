...
// Function to delete lval* and release memory
void lval_del(lval* v) {
    switch (v->type) {
        ...
        // Recursively delete all the elements inside
        case LVAL_QEXPR:
        case LVAL_SEXPR:
    ...
    // Deallocate the memory assigned for the lval strut itself
    free(v);
}
...
// Define a macro to clean up code
